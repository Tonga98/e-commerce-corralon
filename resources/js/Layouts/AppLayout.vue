                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex w-full">
                            <form method="POST" class="inline-flex items-center px-1 pt-1 text-black w-full">
                                <input type="search" placeholder="Que estás buscando?"
                                       class="rounded-md border border-none active:border active:border-black w-2/3 mx-auto">
                            </form>
                        </div>
...
<!--                                        <span v-else class="inline-flex rounded-md">
                                    ...
                                    <template #content v-if="$page.props.auth.user">
                                        ...
                                        <DropdownLink :href="route('products.index')"
                                                      v-if="$page.props.user.permissions.includes('update products')">
                                            Productos
                                        </DropdownLink>
                ...
                <div v-if="$page.props.auth.user"
                    ...
                    <div class="pt-2 pb-3 space-y-1" v-if="$page.props.user.permissions.includes('read products')">
                    ...
                    <div v-if="$page.props.auth" class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
